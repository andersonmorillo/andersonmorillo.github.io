...
tags: ["escritura con IA", "ChatGPT", "educación", "originalidad"]
draft: false
---
...
Investigadores de la Universidad de Georgetown analizaron un corpus enorme de ensayos de admisión universitaria — 373.000 en total — comparando los escritos antes y después de ChatGPT. El conjunto de datos era lo suficientemente grande para detectar cambios sutiles tanto en el lenguaje como en el significado, y los resultados fueron llamativos.
...
Este es el núcleo de la homogeneización paradójica. Los estudiantes ahora tienen una herramienta que los ayuda a expresarse con más fluidez, pero esa misma fluidez tiende a suavizar las aristas que hacen memorable a un ensayo.
...
El estudio de Georgetown es un recordatorio de que mejores herramientas no producen automáticamente mejor pensamiento. Pueden hacernos más articulados, pero también pueden hacernos más parecidos. El verdadero desafío ahora es preservar — y enseñar — los hábitos mentales que producen pensamiento genuinamente original.

En un mundo de prosa fluida generada por IA, la habilidad más escasa y valiosa puede ser la voluntad de perseguir una idea que no es la más probable.

## Fuente

- [More Words, Less Thinking — ProFuturo Observatory](https://profuturo.education/en/observatory/21st-century-skills/mas-palabras-menos-pensamiento/)
